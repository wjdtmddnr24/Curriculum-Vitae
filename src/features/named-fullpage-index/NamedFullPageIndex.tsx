    ...
    <li className="flex relative" onClick={() => setPageIndex(index)}>
      <span
        className={classNames(
          "mr-3 ml-auto text-2xl hover:text-slate-200 cursor-pointer transition-all duration-700",
          isSelected ? "text-slate-50 dark:text-slate-100" : "text-slate-300 dark:text-slate-400 font-light",
        )}
      >
        {title}
      </span>
