...
export function Profile() {
  return (
    <Card className="grid lg:grid-cols-[repeat(2,1fr)] p-10 lg:p-0 lg:pr-16 dark:divide-slate-600">
      <ProfileHeader />
      <div className="grid lg:grid-cols-[18rem_18rem] content-center gap-8 text-slate-600 dark:text-slate-300">
        <div>
          <div className="text-slate-700 dark:text-slate-200 font-bold text-xl mb-2.5">Info</div>
        ...
        <div>
          <div className="text-slate-700 dark:text-slate-200 font-bold text-xl mb-2.5">Career</div>
          <IconList className="space-y-0.5 break-keep">
        ...
        <div>
          <div className="text-slate-700 dark:text-slate-200 font-bold text-xl mb-2.5">Education</div>
          <IconList className="space-y-0.5 break-keep">
